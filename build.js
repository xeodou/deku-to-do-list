...
var Todo = {
  ...
  render: function render(c) {
    ...
    return _deku.element(
      ...
      _deku.element(
        'a',
        { href: 'javascript:;', onClick: onRemove },
        'Remove'
      )
    );
  }
...
var Add = {
  ...
  render: function render(c) {
    ...
    return _deku.element('input', { type: 'text', onKeyDown: onAdd, placeholder: 'to do...' });
  }
...
var List = {
  ...
  render: function render(c) {
    ...
    var children = items.map(function (i) {
      return _deku.element(Todo, { item: i });
    });
    return _deku.element(
      'div',
      null,
      _deku.element(Add, null),
      children
    );
  }
};
...
var app = _deku.tree(_deku.element(List, { items: items }));

app.set('removeTodo', function (v) {
  items = items.filter(function (i) {
    return i != v;
  });
  app.mount(_deku.element(List, { items: items }));
});
