...
var Todo = {
  ...
  render: function render(_ref) {
    ...
    var onRemove = function onRemove(data, event) {
      dispatch({
        type: 'REMOVE',
        data: data
      });
    ...
    return (0, _deku.element)(
      ...
      (0, _deku.element)(
        'a',
        { href: 'javascript:', onClick: onRemove.bind(null, item) },
        'Remove'
      )
    );
  }
...
var Add = {
  ...
  render: function render(_ref2) {
    ...
    return (0, _deku.element)('input', { type: 'text', onKeyDown: onAdd, placeholder: 'to do...' });
  }
...
var List = {
  ...
  render: function render(_ref3) {
    ...
    var children = props.items.map(function (i) {
      return (0, _deku.element)(Todo, { item: i });
    });
    return (0, _deku.element)(
      'div',
      null,
      (0, _deku.element)(Add, null),
      children
    );
  }
};
...
var render = (0, _deku.createApp)(document.body, function (action) {
  switch (action.type) {
    case 'REMOVE':
  ...
  render((0, _deku.element)(List, { items: items }));
});
